...
Stage 3: draft_reply now retrieves relevant knowledge base chunks and cites sources.
"""
...
def draft_reply(
    ...
    Stage 3: retrieves relevant knowledge base chunks and includes them as
    context so the LLM can produce a grounded, cited answer.
